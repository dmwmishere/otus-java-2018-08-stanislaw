...
public class SearchUserServlet extends HttpServlet {
    ...
    private DBService dbSrv;

    @Override
    public void init(){
        dbSrv = SpringContextListener.getSpringBean("dbSrv", DBService.class);
        templateProcessor = SpringContextListener.getSpringBean("tmpPrc", TemplateProcessor.class);
    }
